...
public class Utilidades {
    ...
    public static String CREAR_TABLA_USUARIOS ="CREATE TABLE "+TABLA_USUARIO+" ("+CAMPO_ID+" INTEGER, "+CAMPO_NOMBRE+" TEXT, "+CAMPO_TIPO+" INTEGER, "+CAMPO_EMAIL+" TEXT, "+CAMPO_GENERO+" INTEGER, "+CAMPO_NACIMIENTO+" TEXT, "+CAMPO_DIRECCION+" TEXT, "+CAMPO_TELMOVIL+" TEXT, "+CAMPO_TELCASA+" TEXT, "+CAMPO_TELOFICINA+" TEXT, "+CAMPO_DEPENDIENTES+" TEXT, "+CAMPO_NOTAS+" TEXT)" ;
